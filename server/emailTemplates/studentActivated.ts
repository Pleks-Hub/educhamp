...
export function buildStudentActivatedEmail(data: StudentActivatedEmailData): {
  ...
  const dateStr = activatedAt.toLocaleDateString("en-US", {
    weekday: "long",
    year: "numeric",
    month: "long",
    day: "numeric",
  ...
  const subject = `${studentFirst} has activated their EduChamp account!`;
  ...
  <div class="wrapper">
    <div class="card">
      <div class="header">
        ...
        <p>${studentFirst} is ready to learn</p>
      </div>
      <div class="body">
        <p class="greeting">Hi ${parentFirst}!</p>
        <p class="text">
          Great news — <strong>${studentName}</strong> has successfully created their password and signed in to EduChamp for the first time!
        </p>

        <div class="success-box">
          <div class="icon">✅</div>
          <div class="title">Account Active</div>
          <div class="detail">${studentFirst} can now access their courses and start learning</div>
        </div>
        ...
        <p class="text">
          You can monitor ${studentFirst}'s progress anytime from your Parent Dashboard — including mastery levels, quiz scores, and learning activity.
        </p>

        <a href="https://educhamp.co" class="cta-btn">View Parent Dashboard</a>
      </div>
      <div class="footer">
...
Great news — ${studentName} has successfully created their password and signed in to EduChamp for the first time!

Student: ${studentName}
Email: ${studentEmail}
Activated: ${dateStr}

You can monitor ${studentFirst}'s progress anytime from your Parent Dashboard at https://educhamp.co
